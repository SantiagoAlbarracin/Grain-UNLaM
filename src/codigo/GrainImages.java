...
public class GrainImages {
	...
	public GrainImages(byte[] clave, byte[] semilla, byte[] textoPlano) throws Exception {
		this.keystreamGenerator = new KeystreamGenerator(toShortArray(clave), toShortArray(semilla));
